...
<body>
    ...
    <main>
        <div class="main-box top">
            <div class="top">
                <div class="box">
                    <p>Hello <b><p>Guest</b>, Welcome</p>
                </div>
                <div class="box">
                    <p>Your email is <b>please login to your account to access more features</b>.</p>
                </div>
            </div>
            ...
            <div>
                ...
                "<div class='box' style='text-align: justify;'>
                    ...
                    <h4>Warm Welcome to the Members of Passi City Online Portal<br><br>
                     ...
                     "<div class='box posting-section'>"
                    <h2>Posts by Member</h2>
                    Welcome to the Guest page of the Passi city tourism portal
